...
PRIMITIVE(Caar, "caar", 1, 0, 0)
PRIMITIVE(Cadr, "cadr", 1, 0, 0)
PRIMITIVE(Cdar, "cdar", 1, 0, 0)
PRIMITIVE(Cddr, "cddr", 1, 0, 0)
PRIMITIVE(Caaar, "caaar", 1, 0, 0)
PRIMITIVE(Caadr, "caadr", 1, 0, 0)
PRIMITIVE(Cadar, "cadar", 1, 0, 0)
PRIMITIVE(Caddr, "caddr", 1, 0, 0)
PRIMITIVE(Cdaar, "cdaar", 1, 0, 0)
PRIMITIVE(Cdadr, "cdadr", 1, 0, 0)
PRIMITIVE(Cddar, "cddar", 1, 0, 0)
PRIMITIVE(Cdddr, "cdddr", 1, 0, 0)
PRIMITIVE(Caaaar, "caaaar", 1, 0, 0)
PRIMITIVE(Caaadr, "caaadr", 1, 0, 0)
PRIMITIVE(Caadar, "caadar", 1, 0, 0)
PRIMITIVE(Caaddr, "caaddr", 1, 0, 0)
PRIMITIVE(Cadaar, "cadaar", 1, 0, 0)
PRIMITIVE(Cadadr, "cadadr", 1, 0, 0)
PRIMITIVE(Caddar, "caddar", 1, 0, 0)
PRIMITIVE(Cadddr, "cadddr", 1, 0, 0)
PRIMITIVE(Cdaaar, "cdaaar", 1, 0, 0)
PRIMITIVE(Cdaadr, "cdaadr", 1, 0, 0)
PRIMITIVE(Cdadar, "cdadar", 1, 0, 0)
PRIMITIVE(Cdaddr, "cdaddr", 1, 0, 0)
PRIMITIVE(Cddaar, "cddaar", 1, 0, 0)
PRIMITIVE(Cddadr, "cddadr", 1, 0, 0)
PRIMITIVE(Cdddar, "cdddar", 1, 0, 0)
PRIMITIVE(Cddddr, "cddddr", 1, 0, 0)
